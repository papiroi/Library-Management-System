...
public class BookDialog extends JDialog implements ActionListener {
    ...
    public BookDialog(
        ...
        tfAuthor.setText(oldAuthor);
        tfDescription.setText(oldDescription);
        tfPrice.setText(oldPrice);
    ...
    public void saveAction() {
        ...
        setBookAuthor(tfAuthor.getText().trim());
        setBookDescription(tfDescription.getText().trim());
        setBookPrice(tfPrice.getText().trim());
