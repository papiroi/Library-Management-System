...
public class BookPage_Admin extends JFrame implements ActionListener {
    ...
    public void addAction() {
        ...
        if (dialog.getBookName() != null && dialog.getBookIsbn() != null && dialog.getBorrowStatus() != null && dialog.getDate() != null) {
            dialog.setBookID(bModel.insertIntoBooksTableAndSetID(dialog.getBookName(), dialog.getBookIsbn(), dialog.getBorrowStatus(), dialog.getDate(), dialog.getBookAuthor(), dialog.getBookDescription(), dialog.getBookPrice()));
            Object[] addedRow = new Object[]{
                dialog.getBookID(),
                dialog.getBookName(),
                dialog.getBookAuthor(),
                dialog.getBorrowStatus(),
                dialog.getDate(),
                dialog.getBookDescription(),
                dialog.getBookPrice(),
                dialog.getBookIsbn()
            };
    ...
    public void editAction() {
        if (table.getSelectedRow() > -1) {
            ...
            dialog.setBookAuthor(String.valueOf(table.getValueAt(rowInTable, 5)));
            dialog.setBookDescription(String.valueOf(table.getValueAt(rowInTable, 6)));
            dialog.setBookPrice(String.valueOf(table.getValueAt(rowInTable, 7)));
